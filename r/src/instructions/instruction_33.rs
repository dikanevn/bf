...
pub fn process_instruction(
    ...
    msg!("Starting create_and_mint_pnft_with_token2022_and_merkle_proof...");
    ...
    let create_args = CreateV1InstructionArgs {
        name: "pNFT-2022".to_string(),
        symbol: "PNFT22".to_string(),
        uri: "https://example.com/metadata-token2022.json".to_string(),
    ...
    msg!("pNFT created and minted successfully with Token-2022 and Merkle proof verification!");
    Ok(())
}
