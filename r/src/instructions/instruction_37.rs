// pNFT с проверками Merkle и фиксированной коллекцией без верификации
...
pub fn process_instruction(
    ...
    msg!("Starting create_and_mint_pnft_with_token2022_merkle_proof_and_fixed_collection_without_verification...");
    ...
    let collection = Collection {
        verified: false, // Не будет верифицировано
        key: *collection_mint.key,
    };

    let create_args = CreateV1InstructionArgs {
        name: "YAPSTER pNFT 37".to_string(),
        symbol: "YAPPNFT37".to_string(),
    ...
    msg!("pNFT created and minted successfully with Token-2022, Merkle proof verification and unverified collection!");
    Ok(())
}
