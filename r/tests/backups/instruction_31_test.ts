/**
 * Тест для инструкции 31: Создание и минтинг pNFT без проверок
 * 
 * Этот тест проверяет функциональность создания и минтинга Programmable NFT (pNFT)
 * в одной инструкции без дополнительных проверок. Создается новый аккаунт минта,
 * метаданные и токен, который отправляется на ассоциированный токен-аккаунт пользователя.
 */
